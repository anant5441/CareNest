...
const HospitalLoadingScreen = () => {
    ...
    // Array of rotating subtexts for hospital finding
    const subtexts = [
        "Scanning your area for medical facilities",
        "Checking hospital availability and wait times",
        "Finding the closest emergency care centers",
        "Verifying insurance coverage and accepted plans",
        "Looking up specialist departments nearby",
        "Checking real-time bed availability",
        "Finding 24/7 urgent care facilities",
        "Locating hospitals with shortest drive times",
        "Checking quality ratings and patient reviews",
        "Finding facilities with your preferred doctors",
        "Almost ready with your healthcare options",
        "Finalizing the best matches for your needs"
    ];
    ...
    // Floating animations for medical icons
    useEffect(() => {
...
export default HospitalLoadingScreen;